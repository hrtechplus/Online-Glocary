...
<div class="container">
    <div class="d-flex justify-content-between align-items-center py-3 bg-light">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="home.jsp" class="btn btn-outline-primary me-2"><i style="font-size:18px" class="fa">&#xf0a8;</i> Back</a>
    ...
    <ul class="nav nav-pills nav-justified mb-3">
        ...
        <li class="nav-item"><a href="changeSecurityQuestion.jsp" class="nav-link">Change Security Question <i class="fas fa-redo"></i></a></li>
        <li class="nav-item"><a href="changeMobileNumber.jsp" class="nav-link">Change Mobile Number <i class='fas fa-mobile-alt'></i></a></li>
    </ul>
